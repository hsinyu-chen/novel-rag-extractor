...
│ 關於挫折：                                                                                                                                                                │
│                                                                                                                                                                           │
│ 在《爆肝》第一集中，主角佐藤（鈴木一郎）在進入這個高擬真 AR 介面後，雖然很快展現出驚人的能力，但他遭遇了多層次的巨大挫折與挑戰：                                          │
│                                                                                                                                                                           │
│  1 生存與世界觀的衝擊： 他最初在荒野中被數量龐大、等級極高的蜥蜴人騎兵弓箭襲擊，被迫進入這個高風險的戰鬥場域。                                                            │
│  2 社會結構的壓迫： 在聖留市，他立即發現這個世界存在盛行的奴隸制度和嚴重的種族歧視，這與他來自現實世界的價值觀形成巨大衝突。                                              │
│  3 政治陰謀的介入：                                                                                                                                                       │
│    他目睹了神官利用「積功德」煽動群眾，對獸族奴隸進行暴力攻擊，主角被迫介入，利用一系列技能瓦解了神官和公會成員所發動的陰謀，揭露了他們利用民眾不安的惡意目的。           │
│  4 災難的爆發： 主角在戰鬥中引發了超出預期的巨大隕石雨，導致龍之谷發生大規模坍塌，確認了這個世界的高風險本質。                                                            │
│  5 致命的危機：                                                                                                                                                           │
│    最為嚴重的挫折是，當他介入阻止魔族攻擊時，被地面扭曲的力量拖入魔族迷宮深處，開啟了一場生死攸關的「迷宮逃脫任務」，並在迷宮深處遭遇了骷髏軍團和眼球魔族等極高階的敵人， │
│    陷入了極度危險的戰鬥局面。                                                                                                                                             │
│                                                                                                                                                                           │
│ 關於「純爽文」的判斷：                                                                                                                                                    │
│                                                                                                                                                                           │
│ 雖然主角的能力不斷提升，獲得了「救命者」、「殺蟲者」、「勇者」、「魔族者〔上級〕」等多個重要稱號，並且在面對強大敵人時展現出極強的戰力（在極度劣勢下成功對上級魔族造成實  │
│ 質性傷害），具有典型的爽文元素。                                                                                                                                          │
│                                                                                                                                                                           │
│ 然而，從劇情層面來看，它並非「純爽文」。小說的基調被描述為「災難性/極度緊張」，劇情深度包含著：                                                                           │
│                                                                                                                                                                           │
│  • 社會批判性： 深刻描繪了奴隸制度和種族歧視的殘酷現狀。                                                                                                                  │
│  • 存在主義的疑問： 主角對自己身處的 AR 介面（遊戲世界）的本質懷有持續的疑惑，這挑戰了簡單的「打怪升級」模式。                                                            │
│  • 複雜的道德抉擇： 劇情涉及主角如何應對社會階級的差異、奴隸的困境，以及他自身的身份和神性的探索，這賦予了作品更宏大和沉重的敘事底色。                                    │
│                                                                                                                                                                           │
│ 總體來說，《爆肝》是一部在動作和能力爆發（爽點）基礎上，融入了深刻的社會批判和世界本質探討（深度）的史詩奇幻/動作作品。                                                   │
╰───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
```

### 範例 4：抽象/主觀查詢與多工具回退鏈

抽象、無明確關鍵字的問題（如「感情戲」、「打鬥場面多嗎」）難以單靠 entity 檢索回答。此例可看到 agent 主動串接 `find_entity_scenes`（嘗試以條目軸找線索）→ `search_scenes`（改走 chunk 層語意檢索場景）→ `get_scene_content`（讀原文驗證），並在證據有限時誠實標明「主要呈現內心獨白與日常互動」，避免幻覺式擴張。
...
────────────────────────────────────────────────────────────────────────────────── Answer ───────────────────────────────────────────────────────────────────────────────────
╭───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╮
│ 根據檢索到的資料，小說中存在角色對於「感情觀」的深刻反思。在第一卷的第四章「約會」中，主角佐藤在醒來後便開始反思自己的感情模式，他提到自己總是與年齡較小的女孩維持朋友  │
│ 關係，而他心儀的對象卻多半是年齡較大的人。                                                                                                                                │
│                                                                                                                                                                           │
│ 雖然檢索的內容主要呈現角色的內心獨白和日常互動，但這些場景體現了角色對於情感的關注與思考，可以被視為情節中的「感情戲」脈絡。                                              │
│                                                                                                                                                                           │
│ 總體而言，小說中包含了角色之間的交流和關於情感的內心探討，這些元素構成了情感層面的描繪。                                                                                  │
╰───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
```

### 範例 5：REPL 互動模式（連續多輪對話 + notes 累積）
